...
assert_file_contains "$ROOT_DIR/shared/.zprofile.macos" 'security find-generic-password -a "$USER" -s gbrain-remote-token -w'
assert_file_contains "$ROOT_DIR/shared/.zprofile.macos" 'export GBRAIN_REMOTE_TOKEN'
...
assert_file_contains "$ROOT_DIR/README.md" 'security add-generic-password -a "$USER" -s gbrain-remote-token -w'
assert_file_contains "$ROOT_DIR/README.md" 'GBRAIN_REMOTE_TOKEN'
